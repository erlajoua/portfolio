const Presentation = () => {
	return (
		<div className="flex flex-col gap-8 text-slate-200 text-base">
			<p>
				I’m a developer passionate about crafting accessible,
				pixel-perfect user interfaces that blend thoughtful design with
				robust engineering. <span className="text-white">My favorite</span> work lies at the intersection of
