    ...
    >
      ...
      <motion.div 
        ...
        style={{
          width: "300px",
          height: "300px",
          background: "radial-gradient(circle, rgba(96, 165, 250, 0.8) 0%, rgba(96, 165, 250, 0.1) 70%, transparent 100%)",
        }}
      />
      ...
      <div className="lg:w-1/2 lg:ml-auto z-10">
        <section id="about" className="py-16 px-8 lg:pl-0 lg:pr-64 relative">
          <motion.div
        ...
        <section id="experience" className="min-h-screen py-16 px-8 lg:pl-0 lg:pr-64 relative">
          <motion.div
            initial={{ opacity: 0 }}
        ...
        <section id="projects" className="min-h-screen py-16 px-8 lg:pl-0 lg:pr-64 relative">
          <motion.div
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            transition={{ duration: 0.5 }}
