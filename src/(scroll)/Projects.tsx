    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Numéro du projet */}
                <motion.div
                    className="absolute top-6 right-6 w-8 h-8 rounded-full bg-gradient-to-br from-blue-500/20 to-cyan-500/20 
                              border border-blue-500/30 flex items-center justify-center text-xs font-bold text-blue-300"
